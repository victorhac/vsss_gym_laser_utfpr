...
class Configuration:
    ...
    model_goalkeeper_v2_path = configuration["model"]["goalkeeper-v2"]["path"]
    ...
    game_states_goal_kick_foe_team_positionings = configuration["game"]["states"]["goal-kick"]["foe-team"]["positionings"]
    game_states_goal_kick_foe_team_positionings_ball_x = game_states_goal_kick_foe_team_positionings["ball"]["x"]
    game_states_goal_kick_foe_team_positionings_ball_y = game_states_goal_kick_foe_team_positionings["ball"]["y"]
    game_states_goal_kick_foe_team_positionings_0_x = game_states_goal_kick_foe_team_positionings["0"]["x"]
    game_states_goal_kick_foe_team_positionings_0_y = game_states_goal_kick_foe_team_positionings["0"]["y"]
    game_states_goal_kick_foe_team_positionings_1_x = game_states_goal_kick_foe_team_positionings["1"]["x"]
    game_states_goal_kick_foe_team_positionings_1_y = game_states_goal_kick_foe_team_positionings["1"]["y"]
    game_states_goal_kick_foe_team_positionings_2_x = game_states_goal_kick_foe_team_positionings["2"]["x"]
    game_states_goal_kick_foe_team_positionings_2_y = game_states_goal_kick_foe_team_positionings["2"]["y"]
    ...
    game_states_free_ball_quadrant_1_positionings_0_x = game_states_free_ball_quadrant_1_positionings["0"]["x"]
    game_states_free_ball_quadrant_1_positionings_0_y = game_states_free_ball_quadrant_1_positionings["0"]["y"]
    ...
    game_states_free_ball_quadrant_2_positionings_0_x = game_states_free_ball_quadrant_2_positionings["0"]["x"]
    game_states_free_ball_quadrant_2_positionings_0_y = game_states_free_ball_quadrant_2_positionings["0"]["y"]
    ...
    game_states_free_ball_quadrant_3_positionings_0_x = game_states_free_ball_quadrant_3_positionings["0"]["x"]
    game_states_free_ball_quadrant_3_positionings_0_y = game_states_free_ball_quadrant_3_positionings["0"]["y"]
    ...
    game_states_free_ball_quadrant_4_positionings_0_x = game_states_free_ball_quadrant_4_positionings["0"]["x"]
    game_states_free_ball_quadrant_4_positionings_0_y = game_states_free_ball_quadrant_4_positionings["0"]["y"]
    ...
    game_states_kickoff_team_positionings = configuration["game"]["states"]["kickoff"]["team"]["positionings"]
    game_states_kickoff_team_positionings_ball_x = game_states_kickoff_team_positionings["ball"]["x"]
    game_states_kickoff_team_positionings_ball_y = game_states_kickoff_team_positionings["ball"]["y"]
    game_states_kickoff_team_positionings_0_x = game_states_kickoff_team_positionings["0"]["x"]
    game_states_kickoff_team_positionings_0_y = game_states_kickoff_team_positionings["0"]["y"]
    game_states_kickoff_team_positionings_1_x = game_states_kickoff_team_positionings["1"]["x"]
    game_states_kickoff_team_positionings_1_y = game_states_kickoff_team_positionings["1"]["y"]
    game_states_kickoff_team_positionings_2_x = game_states_kickoff_team_positionings["2"]["x"]
    game_states_kickoff_team_positionings_2_y = game_states_kickoff_team_positionings["2"]["y"]

    game_states_kickoff_foe_team_positionings = configuration["game"]["states"]["kickoff"]["foe-team"]["positionings"]
    game_states_kickoff_foe_team_positionings_ball_x = game_states_kickoff_foe_team_positionings["ball"]["x"]
    game_states_kickoff_foe_team_positionings_ball_y = game_states_kickoff_foe_team_positionings["ball"]["y"]
    game_states_kickoff_foe_team_positionings_0_x = game_states_kickoff_foe_team_positionings["0"]["x"]
    game_states_kickoff_foe_team_positionings_0_y = game_states_kickoff_foe_team_positionings["0"]["y"]
    game_states_kickoff_foe_team_positionings_1_x = game_states_kickoff_foe_team_positionings["1"]["x"]
    game_states_kickoff_foe_team_positionings_1_y = game_states_kickoff_foe_team_positionings["1"]["y"]
