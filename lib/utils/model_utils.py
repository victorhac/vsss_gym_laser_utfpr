...
class ModelUtils():
    ...
    __defender_folder_name = "defender"
    ...
    __latest_defender_datetime_folder_name = "2024_5_26_12_28_17"
    ...
    @staticmethod
    def get_defender_model() -> DDPG:
        return ModelUtils.get_model_by_relative_path(
            ModelUtils.__defender_folder_name,
            ModelUtils.__latest_defender_datetime_folder_name)
